var GS_UI = {
    ...
    selectUnit : function(player, updateTime, clickpos) {
        player.selectedUnits = getIntersectingUnit(player.units, updateTime, clickpos);
    },
    ...
    selectUnits : function(player, updateTime, dragstart, dragend) {
        player.selectedUnits = getIntersectingUnits(player.units, updateTime, dragstart, dragend);
    },

    getIntersectingUnits : function(unit_list, updateTime, dragstart, dragend) {
