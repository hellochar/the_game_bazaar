...
function GSRenderer(assetLoader) {
...
GSRenderer.prototype.makeUnit = function(color) {
    var geometry = this.assetLoader.biplane || this.assetLoader.cone_geometry;
...
GSRenderer.prototype.makeBullet = function() {
    ...
    var mesh = new THREE.Mesh(this.assetLoader.cone_geometry, this.color_material['rgb(0, 255, 0)']);
